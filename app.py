...
# 2. الحل القطعي الهندسي لحل أزمة السيرفر وربط مسارات الشجرة الفرعية بنجاح
...
# 4. دالة محمية لتشفير صور الكبائن لتعمل سحابياً بأعلى سرعة وسلاسة
...
# تشفير كافة الصور بالأسماء والصيغ الدقيقة المتوافقة مع مجلد assets
...
# 6. الاستدعاء الفردي والصافي الوحيد (مرة واحدة فقط) لشريط النافبار المعزول والمحمي بـ __init__
try:
...
# 7. استدعاء طوابق المرصد الجانبي وقاع المقالات المعزولة بحزم __init__
...
# 8. تقسيم الشاشة حسب الأوزان القياسية المتناسقة (اليمين محتوى واليسار مؤشرات نحيفة)
...
with main_content:
    ...
    # --- إدارة فتح الصفحات الفرعية الجديدة والمعزولة بشكل مستقل ---
